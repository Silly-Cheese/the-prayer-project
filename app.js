...
function renderPrayerRequests(requests) {
  if (!requests.length) { prayerGrid.innerHTML = `<div class="empty">No approved prayer requests are currently posted. Once a request is approved, it will appear here.</div>`; return; }
