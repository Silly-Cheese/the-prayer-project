document.addEventListener("DOMContentLoaded", () => {
  ...
  navLinks.innerHTML = `
    ...
    <div class="nav-group"><button class="nav-group-title" type="button" aria-expanded="false">Initiatives <span>▾</span></button><div class="nav-group-grid"><a href="bibles-within-reach.html" data-page="bibles-within-reach.html"><strong>Bibles Within Reach</strong><span>Putting the Word of God within reach</span></a></div></div>
